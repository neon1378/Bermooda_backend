...
import core.routing as CoreManager
...
routers = SuportManager.websocket_urlpatterns + CoreManager.websocket_urlpatterns + project_manager.websocket_urlpatterns + CrmManager.websocket_urlpatterns +WorkSpaceChat.websocket_urlpatterns
